...
internal class PermissionManageFileFragment : Fragment() {
  ...
  companion object {
    ...
    fun delegate(
      ...
      activity.runOnUiThread {
        ...
        var fragment = fm.findFragmentByTag(PermissionManageFileFragment::class.java.name)
        if (fragment != null) {
          transaction.remove(fragment)
        }
        fragment = PermissionManageFileFragment()
        fragment.callback = callback
        transaction.add(fragment, PermissionManageFileFragment::class.java.name)
